import { initDb, closeDb, caravans } from '../db/db.ts';
  ...
  try {
    ...
    const sampleCaravans = [
      ...
      },
      {
        title: 'Polar 547 GL',
        slug: 'polar-547-gl',
        description: 'Надежная Швецкая Прицеп-дача в отличном состоянии. Отлично подходит как первая Прицеп-дача.',
        year: 1989,
        price: 1500000,
        status: 'available',
        featured: 1,
