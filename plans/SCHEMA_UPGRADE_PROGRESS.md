...
- [ ] Add seasonal pricing based on condition and features

## Notes

- Schema work is complete for now.
- This plan tracks only the uncompleted items that still need implementation.
