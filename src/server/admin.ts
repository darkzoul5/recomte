...
import { ensureInitialAdminUser } from '../modules/auth/index.ts';
import { registerAuthRoutes } from '../modules/auth/index.ts';
import { registerAdminApiRoutes, registerAdminRoutes } from '../modules/admin/index.ts';
